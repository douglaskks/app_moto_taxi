...
class _PassengerHomeState extends State<PassengerHome> {
  ...
  void initState() {
    ...
    _determinePosition();
    _loadUserStatistics();
    // Configurar a barra de status ao iniciar a tela
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: Colors.blue[800], // Mesma cor do seu app bar
  ...
  Future<void> _loadUserStatistics() async {
    ...
    try {
      ...
      setState(() {
        _totalRides = stats['total_rides'] ?? 0;
        _totalDistance = stats['total_distance'] ?? 0;
        _totalSaved = stats['total_saved'] ?? 0;
        _loadingStats = false;
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        extendBodyBehindAppBar: true, // Estende o corpo para trás da app bar
        body: SafeArea(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                _buildStatItem(
                                  _loadingStats ? "" : "${_totalDistance.toStringAsFixed(0)}km", 
                                  "Percorridos", 
                                  Icons.map, 
                                  Colors.green[700]!,
                                  isSmallScreen
                                ...
                                _buildStatItem(
                                  _loadingStats ? "" : "R\$${_totalSaved.toStringAsFixed(2)}", 
                                  "Economizados", 
                                  Icons.savings, 
                                  Colors.amber[700]!,
                                  isSmallScreen
